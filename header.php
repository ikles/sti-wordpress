...
<body <?php body_class(); ?>>	
	...
	<div class="wrapper">
		<header class="header <? if(is_front_page()) {echo 'index-header';} ?>  <?php if (get_field('vysota') == 'auto') {echo 'auto';}?> <?php if (get_field('banner_show') == 'no') {echo 'auto';} ?>" id="header">       
			...
			<?php if (get_field('banner_show') == 'yes'): ?>
				...
				<?php if (!$group['banner_bg']): ?>
					<img src="<? echo bloginfo('template_url').'/img/header-bg6.jpg'; ?>" alt="" class="header__bg">
				<?php endif; ?>

				<?php if ($group['banner_bg']): ?>
					<img src="<? echo $group['banner_bg']; ?>" alt="" class="header__bg">
				<?php endif; ?>
				<div class="banner">
